...
mod tests {
    ...
    fn boolean() {
        ...
        assert_eq!(harness("let x = 0; if true {if x == 1 {print(1);} otherwise {print(0);};};"), "0\n");
        assert_eq!(harness("let x = 1; if true {if x == 1 {print(1);} otherwise {print(0);};};"), "1\n");
    }
    ...
    fn vars() {
        ...
        assert_eq!(harness("let x = 0; print(x); if x == 0 {let x = x + 2; print(x)}; print(x);"), "0\n2\n0\n");
        assert_eq!(harness("let x = 0; print(x); let x = x + 2; print(x);"), "0\n2\n");
    }
}
